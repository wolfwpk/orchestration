...
/**
 * Developed by Park based on original google demo.
 * Add midi generation and communication function with server
 */
...
function saveRecording() {
    ...
    let seq = recorder.full;
    seq.ticks_per_quarter = 220
    // document.getElementById("audio-container").innerHTML = "<audio controls=\"controls\">\n" +
    //             "        <source src=\"/wav\" type=\"audio/mpeg\">\n" +
    //             "        <embed height=\"100\" width=\"100\" src=\"/wav\"/>\n" +
    //             "    </audio>";
    fetch('/live', {
        method: 'POST',
        headers: {
